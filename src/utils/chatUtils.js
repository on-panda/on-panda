...
export function dialogDifferent(dialog1, dialog2, modelRoles = ['assistant',]) {
    ...
    if (response1 && response2) {
        var seq1 = messageToSeq(response1, { collapseSingleContentSection: false })
        var seq2 = messageToSeq(response2, { collapseSingleContentSection: false })
...
export function messageToSeq(message, { includeFinishReason = true, collapseSingleContentSection = true } = {}) {
    message = message || {}
